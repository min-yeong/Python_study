...
def mask_setTo():
    src = cv2.imread('D:/python/Image/lenna.bmp', cv2.IMREAD_COLOR)
    mask = cv2.imread('D:/python/Image/mask_smile.bmp', cv2.IMREAD_GRAYSCALE)
...
def mask_copyTo():
    src = cv2.imread('D:/python/Image/airplane.bmp', cv2.IMREAD_COLOR)
    mask = cv2.imread('D:/python/Image/mask_plane.bmp', cv2.IMREAD_GRAYSCALE)
    dst = cv2.imread('D:/python/Image/field.bmp', cv2.IMREAD_COLOR)
...
def time_inverse():
    src = cv2.imread('D:/python/Image/lenna.bmp', cv2.IMREAD_GRAYSCALE)
...
def useful_func():
    img = cv2.imread('D:/python/Image/lenna.bmp', cv2.IMREAD_GRAYSCALE)
