...
def func1():
    img1 = cv2.imread('D:/python/Image/cat.bmp', cv2.IMREAD_GRAYSCALE)
...
def func3():
    img1 = cv2.imread('D:/python/Image/dog.bmp')
...
def func4():
    img1 = cv2.imread('D:/python/Image/lenna.bmp', cv2.IMREAD_GRAYSCALE)
