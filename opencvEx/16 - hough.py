...
def hough_lines():
    src = cv2.imread('D:/python/Image/building.jpg', cv2.IMREAD_GRAYSCALE)
...
def hough_line_segments():
    ...
    edge = cv2.Canny(src, 50, 150)
    lines = cv2.HoughLinesP(edge, 1, math.pi/180, 160, minLineLength=5, maxLineGap=5)
...
def hough_circles():
    src = cv2.imread('D:/python/Image/coins.png', cv2.IMREAD_GRAYSCALE)
